...
# Optimal Sigma, R
pts_optimal = mlines.Line2D([], [], linestyle='None',  color=None, marker='*', markerfacecolor=optimal_star, markeredgecolor=optimal_star, markersize=7, alpha=1)

# Low State Estimation Losses 
lne_se_loss = mlines.Line2D([], [], linestyle='-',  color='tan', marker='o', markerfacecolor='tan', markeredgecolor='tan', markersize=7)

# Low Forecasting Losses 
lne_f_loss = mlines.Line2D([], [], linestyle='-',  color='c', marker='o', markerfacecolor='c', markeredgecolor='c', markersize=7)
...
pts_data =  mlines.Line2D([], [], linestyle='None',  color=None, marker='x', markerfacecolor='darkblue', markeredgecolor='darkblue', markersize=7)
...
RISK_L = [r'Random Init. ($\sigma, R$)', 'Low State Est. Risk', 'Low Forecasting Risk', r'Tuned ($\sigma, R$)',  'Optimal Risk Traj.', 'Training', 'Unoptimal Traj.']                              
