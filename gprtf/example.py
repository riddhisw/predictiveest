# -*- coding: utf-8 -*-
"""
Created on Tue Jun  6 16:35:56 2017

@author: https://github.com/shuuki4/Basic-Gaussian-Process-on-Tensorflow/blob/master/GPTensorflow.py
"""
import numpy as np
...
#plt.figure()
#plt.plot(sample_trainx, sample_trainx, 'kx', label='Training Pts')
#plt.plot(sample_testx, test_mu, 'go', label = 'Test Pts')
#plt.legend(loc=0)
#plt.show()
