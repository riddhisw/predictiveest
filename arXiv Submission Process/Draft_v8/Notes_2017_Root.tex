...
% Loads packages and newcommands
\input{./Notes_2017_DocPreamble}

\begin{document}
	
% Title, authorinfo, affliation and abstract	
%\include{./tex/Notes_2017_FrontMatter}
...
%\include{./tex/Notes_2017_Main_v8}
...
%We note that the bias of a coin flip, namely, $ P(d_n|f_n, \tau, t) \propto z_n$, cannot be measured directly but only inferred in the frequentist sense for a large number of parallel runs, or in the Bayesian sense, by deconstructing the problem further using Bayes rule.
...
% \appendix
% \begin{widetext}
%  \include{./tex/Notes_2017_A_Supplements}
% \end{widetext}
